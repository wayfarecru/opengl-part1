...
const char* vertFileName = "c31-uniform-tri.vert";
const char* fragFileName = "c31-uniform-tri.frag";
...
glm::vec4 moveCur = glm::vec4( 0.0F, 0.0F, 0.0F, 0.0F ); // movement vector, current time
